...
def process_song_file(cur, filepath):
    '''
    Read song file and insert into songs and artists tables

            Parameters:
                    cur: database connection cursor
                    filepath: location of song json file
...
def process_log_file(cur, filepath):
    '''
    Read log file and insert into time, users, and songplays tables

            Parameters:
                    cur: database connection cursor
                    filepath: location of log json file
...
def process_data(cur, conn, filepath, func):
    '''
    Get all files in directory and call process_file functions to process each file

            Parameters:
                    cur: database connection cursor
                    conn: connection to database
                    filepath: directory of json file
